...
const AccountsPage = lazy(() => import("@/pages/Management/Accounts").then((module) => ({ default: module.AccountsPage })));
const AdminHome = lazy(() => import("@/pages/Home").then((module) => ({ default: module.AdminHome })));
const AuditPage = lazy(() => import("@/pages/Management/Audit").then((module) => ({ default: module.AuditPage })));
...
const CredentialOperationsPage = lazy(() => import("@/pages/Operations/TenantOperations").then((module) => ({ default: module.CredentialOperationsPage })));
const CustomersPage = lazy(() => import("@/pages/Management/Customers").then((module) => ({ default: module.CustomersPage })));
const DarkWebArticleEditorPage = lazy(() => import("@/pages/CustomerOperations/DarkWebArticleEditor").then((module) => ({ default: module.DarkWebArticleEditorPage })));
...
const FingerprintIconsPage = lazy(() => import("@/pages/Management/FingerprintIcons").then((module) => ({ default: module.FingerprintIconsPage })));
const FingerprintWatchGroupsPage = lazy(() => import("@/pages/CustomerOperations/FingerprintWatchGroups").then((module) => ({ default: module.FingerprintWatchGroupsPage })));
const IngestionPage = lazy(() => import("@/pages/CustomerOperations/Ingestion").then((module) => ({ default: module.IngestionPage })));
const InterfacesPage = lazy(() => import("@/pages/CustomerOperations/Interfaces").then((module) => ({ default: module.InterfacesPage })));
const OperationsStatusPage = lazy(() => import("@/pages/Operations/Status").then((module) => ({ default: module.OperationsStatusPage })));
const PasswordPolicyPage = lazy(() => import("@/pages/Management/PasswordPolicy").then((module) => ({ default: module.PasswordPolicyPage })));
const ProfilePage = lazy(() => import("@/pages/Auth/Profile").then((module) => ({ default: module.ProfilePage })));
const PublicationPoliciesPage = lazy(() => import("@/pages/Operations/TenantOperations").then((module) => ({ default: module.PublicationPoliciesPage })));
const SchedulesPage = lazy(() => import("@/pages/Operations/Schedules").then((module) => ({ default: module.SchedulesPage })));
const TaskCenterPage = lazy(() => import("@/pages/Operations/TaskCenter").then((module) => ({ default: module.TaskCenterPage })));
const TargetsPage = lazy(() => import("@/pages/CustomerOperations/Targets").then((module) => ({ default: module.TargetsPage })));
const TenantPortalPage = lazy(() => import("@/pages/TenantPortal").then((module) => ({ default: module.TenantPortalPage })));
const VulnerabilitiesPage = lazy(() => import("@/pages/CustomerOperations/Vulnerabilities").then((module) => ({ default: module.VulnerabilitiesPage })));
const WorkerNodesPage = lazy(() => import("@/pages/Operations/WorkerNodes").then((module) => ({ default: module.WorkerNodesPage })));
